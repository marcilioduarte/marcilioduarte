...
🧑‍🎓 I hold a bachelor's degree in Economics and a postgraduate qualification in Data Science. Currently, I am employed as a Mid-Level Data Analyst/Scientist.
...
📊 In the realm of data visualization, one of my notable projects is the "Identidades Territoriais" dashboard which I developed (and manage as P.O.) at my job using Power BI [Identidades Territorias Dashboard](https://inteligencia.sebraemg.com.br/painel/identidades-territoriais). Beyond Power BI, I have developed various other data visualization products.
